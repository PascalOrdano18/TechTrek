      ...
      <div className="relative z-10">
        ...
        <header className="fixed top-0 w-full z-50 backdrop-blur-xl bg-black/30 border-b border-white/20">
          <div className="container mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <Button size="sm" className="bg-primary text-black hover:bg-primary/90 transition-colors font-semibold">
              Únete
            </Button>
          </div>
        </header>
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="mb-8">
              <Link href="https://www.itba.edu.ar/" target="_blank" rel="noopener noreferrer">
                <Badge variant="outline" className="border-primary/60 text-primary bg-primary/20 mb-6 hover:bg-primary/30 transition-colors cursor-pointer font-semibold">
                  ITBA • Buenos Aires
                </Badge>
              </Link>
            </div>

            <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-white via-gray-100 to-gray-200 bg-clip-text text-transparent">
              Tech Trek
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-primary text-black hover:bg-primary/90 transition-colors group font-semibold">
                Comenzar Viaje
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white/40 text-white hover:bg-white/20 hover:text-white hover:border-white/60 bg-transparent transition-colors font-semibold"
              >
                Explorar
              </Button>
            </div>
        ...
        <section id="about" className="py-32 px-6">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">¿Qué es Tech Trek?</h2>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-6 text-white">Nuestro Impacto</h3>
        ...
        <section className="py-32 px-6 bg-white/5">
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Nuestro Team</h2>
              <div className="w-24 h-1 bg-primary mx-auto mb-8"></div>
              ...
              {[
                ...
                >
                  <CardContent className="p-8 text-center">
                    <div className="w-24 h-24 bg-gradient-to-br from-primary/50 to-primary/20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-105 transition-transform">
                    ...
                    <p className="text-primary text-lg mb-3 font-semibold">{member.role}</p>
                    <p className="text-gray-100 mb-1">{member.career}</p>
        ...
        <section className="py-32 px-6">
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Contributors</h2>
              <div className="w-24 h-1 bg-primary mx-auto mb-8"></div>
              <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              ...
              {[
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <h4 className="font-semibold text-lg mb-2 text-white">{contributor.name}</h4>
        ...
        <section className="py-32 px-6 bg-white/5">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Sponsors</h2>
              <div className="w-24 h-1 bg-primary mx-auto mb-8"></div>
              <p className="text-xl text-gray-200 max-w-2xl mx-auto">Empresas que apoyan nuestra visión tecnológica</p>
            </div>
            ...
            {getSponsorsByTier("Platinum").length > 0 && (
              <div className="mb-20">
                <div className="text-center mb-12">
                  ...
                  <p className="text-gray-200">Nuestros patrocinadores principales</p>
                </div>
                  ...
                  {getSponsorsByTier("Platinum").map((sponsor) => (
                    ...
                    >
                      <CardContent className="p-10 text-center">
                        <div className="w-28 h-28 bg-gradient-to-br from-yellow-400/40 to-yellow-600/20 rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:scale-105 transition-transform shadow-lg">
                          <span className="text-black font-bold text-3xl">{sponsor.name.substring(0, 2)}</span>
                        </div>
                        <h4 className="font-bold text-2xl mb-3 group-hover:text-yellow-400 transition-colors text-white">
                          {sponsor.name}
                        </h4>
                        <p className="text-gray-200 text-sm mb-4">{sponsor.description}</p>
                        <Badge variant="outline" className="border-yellow-400/60 text-yellow-400 bg-yellow-400/20 font-semibold">
                          Platinum Sponsor
                        </Badge>
                      </CardContent>
                    </Card>
            ...
            {getSponsorsByTier("Gold").length > 0 && (
              <div className="mb-20">
                <div className="text-center mb-12">
                  ...
                  <p className="text-gray-200">Patrocinadores oro</p>
                </div>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-5xl mx-auto">
                  {getSponsorsByTier("Gold").map((sponsor) => (
                    ...
                    >
                      <CardContent className="p-8 text-center">
                        <div className="w-20 h-20 bg-gradient-to-br from-yellow-500/40 to-yellow-600/20 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-105 transition-transform">
                          <span className="text-black font-bold text-2xl">{sponsor.name.substring(0, 2)}</span>
                        </div>
                        <h4 className="font-bold text-xl mb-2 group-hover:text-yellow-500 transition-colors text-white">
                          {sponsor.name}
                        </h4>
                        <p className="text-gray-200 text-xs mb-3">{sponsor.description}</p>
                        <Badge variant="outline" className="border-yellow-500/60 text-yellow-500 bg-yellow-500/20 font-semibold">
                          Gold Sponsor
                        </Badge>
                      </CardContent>
                    </Card>
              ...
              <div className="mb-20">
                <div className="text-center mb-12">
                  <div className="flex items-center justify-center gap-2 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-gray-200">Silver</h3>
                    <Star className="w-6 h-6 text-gray-300" />
                  </div>
                  <p className="text-gray-200">Patrocinadores plata</p>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
                  {getSponsorsByTier("Silver").map((sponsor) => (
                    ...
                    >
                      <CardContent className="p-6 text-center">
                        <div className="w-16 h-16 bg-gradient-to-br from-gray-300/40 to-gray-400/20 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform">
                          <span className="text-black font-bold text-lg">{sponsor.name.substring(0, 2)}</span>
                        </div>
                        <h4 className="font-semibold text-sm group-hover:text-gray-100 transition-colors mb-2 text-white">
                          {sponsor.name}
                        </h4>
            ...
            {getSponsorsByTier("Nos acompañan").length > 0 && (
              <div className="mb-16">
                <div className="text-center mb-12">
                  <h3 className="text-xl font-bold text-gray-200 mb-2">Nos acompañan</h3>
                  <p className="text-gray-200">Organizaciones que apoyan nuestra misión</p>
                </div>
            ...
            <div className="text-center mt-16">
              ...
              <Button className="bg-primary text-black hover:bg-primary/90 transition-colors font-semibold">Convertirse en Sponsor</Button>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <div className="text-gray-200 font-medium">Estudiantes</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-primary mb-2">50+</div>
                <div className="text-gray-200 font-medium">Eventos</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-primary mb-2">30+</div>
                <div className="text-gray-200 font-medium">Empresas</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-primary mb-2">5</div>
                <div className="text-gray-200 font-medium">Años</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 px-6">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Únete a Tech Trek</h2>
              <div className="w-24 h-1 bg-primary mx-auto mb-8"></div>
              ...
              <div className="relative group mb-16">
                ...
                <Card className="relative bg-white/10 border-white/20 backdrop-blur-sm group hover:bg-white/15 transition-all duration-500">
                  <CardContent className="p-12 text-center">
                    <div className="mb-8">
                      <div className="w-20 h-20 bg-primary/30 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                        <Rocket className="w-10 h-10 text-primary" />
                      </div>
                      <h3 className="text-3xl font-bold mb-4 text-white">Inscripciones 2025</h3>
                    ...
                    {/* Status Badge */}
                    <div className="mb-8">
                      <Badge variant="outline" className="border-primary/60 text-primary bg-primary/20 px-6 py-2 text-lg font-semibold">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                      <div className="flex items-start gap-4 text-left">
                        <div className="w-8 h-8 bg-primary/30 rounded-full flex items-center justify-center shrink-0 mt-1">
                          <Users className="w-4 h-4 text-primary" />
                        </div>
                        <div>
                          <h4 className="font-semibold mb-2 text-white">Liderazgo Estudiantil</h4>
                      ...
                      <div className="flex items-start gap-4 text-left">
                        ...
                        <div>
                          <h4 className="font-semibold mb-2 text-white">Red Internacional</h4>
                      ...
                      <div className="flex items-start gap-4 text-left">
                        ...
                        <div>
                          <h4 className="font-semibold mb-2 text-white">Experiencia Única</h4>
                      ...
                      <div className="flex items-start gap-4 text-left">
                        ...
                        <div>
                          <h4 className="font-semibold mb-2 text-white">Crecimiento Personal</h4>
                    ...
                    <div className="pt-8 border-t border-white/20">
                      <Button 
                        size="lg" 
                        className="bg-primary text-black hover:bg-primary/90 transition-all duration-300 hover:scale-105 group px-8 py-4 text-lg font-semibold"
                      >
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="bg-white/10 border-white/20 backdrop-blur-sm group hover:bg-white/15 transition-all duration-500">
                  <CardContent className="p-8 text-center">
                    ...
                    <h4 className="font-semibold mb-2 text-white">Una vez al año</h4>
                ...
                <Card className="bg-white/10 border-white/20 backdrop-blur-sm group hover:bg-white/15 transition-all duration-500">
                  <CardContent className="p-8 text-center">
                    <div className="text-3xl mb-4">🎯</div>
                    <h4 className="font-semibold mb-2 text-white">Proceso Selectivo</h4>
        ...
        {/* Footer */}
        <footer id="contact" className="border-t border-white/20 py-16 px-6">
          <div className="container mx-auto max-w-6xl">
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <Link href="#" className="text-gray-200 hover:text-primary transition-colors">
